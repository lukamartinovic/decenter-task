        ...
        <tr>
            <td>
                <div className={style.id}>
                    ...
                    <button onClick={() => setSelectedCDP(data)}>
                        <AiOutlineProfile />
                    </button>
                </div>
            </td>
            <td>
                <span>
                    {Number(formatEther(data.collateral)).toLocaleString()}{" "}
                    <small>{data.collateralType}</small>
                </span>
            </td>
            <td>
                <span>
                    {Number(
                        getTotalDebt(data.debt.toString(), rate.rate)
                    ).toLocaleString()}{" "}
                    <small>DAI</small>
                </span>
            </td>
